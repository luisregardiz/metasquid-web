...
const Navbar = () => {
    ...
    return (
        <div className="w-full bg-meta-dark-100/60 backdrop-blur-lg lg:sticky fixed top-0 z-30 ">
            <header className="flex items-center justify-between py-2 max-w-screen-xl mx-auto px-5 lg:px-0   ">
                <div
